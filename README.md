...
**Inherit from [`APIError`](./src/nest_sdk_python_test_v2/models/apierror.py)**:
* [`UserErrorResponse`](./src/nest_sdk_python_test_v2/models/usererrorresponse.py): Not Found. Status code `404`. Applicable to 1 of 11 methods.*
* [`ResponseValidationError`](./src/nest_sdk_python_test_v2/models/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
