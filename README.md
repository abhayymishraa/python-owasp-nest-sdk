...
[`APIError`](./src/nest_sdk_python_test_v1/models/apierror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary error:**
* [`APIError`](./src/nest_sdk_python_test_v1/models/apierror.py): The base class for HTTP error responses.
...
**Inherit from [`APIError`](./src/nest_sdk_python_test_v1/models/apierror.py)**:
* [`UserErrorResponse`](./src/nest_sdk_python_test_v1/models/usererrorresponse.py): Not Found. Status code `404`. Applicable to 1 of 11 methods.*
* [`ResponseValidationError`](./src/nest_sdk_python_test_v1/models/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
